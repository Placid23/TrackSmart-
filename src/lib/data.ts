...
export const vendors: Vendor[] = [
  {
    ...
    items: [
      { name: 'Jollof Rice & Chicken', price: 1500, mealTime: ['Lunch', 'Dinner'] },
      { name: 'Fried Rice & Beef', price: 1500, mealTime: ['Lunch', 'Dinner'] },
      { name: 'Eba & Egusi Soup', price: 1200, mealTime: ['Lunch', 'Dinner'] },
      { name: 'Yam & Egg Sauce', price: 1000, mealTime: ['Breakfast'] },
      { name: 'Bottled Water', price: 200, mealTime: ['Breakfast', 'Lunch', 'Dinner'] },
      { name: 'Soft Drink', price: 300, mealTime: ['Breakfast', 'Lunch', 'Dinner'] },
    ],
  },
  {
    ...
    items: [
      { name: 'Amala & Gbegiri', price: 1800, mealTime: ['Lunch', 'Dinner'] },
      { name: 'Pounded Yam & Efo Riro', price: 2000, mealTime: ['Lunch', 'Dinner'] },
      { name: 'Shawarma', price: 2500, mealTime: ['Lunch', 'Dinner'] },
      { name: 'Asun (Spicy Goat Meat)', price: 3000, mealTime: ['Dinner'] },
    ],
  },
  {
    name: 'Foodies Corner',
    category: 'Private Food Vendors',
    items: [
      { name: 'Pizza Slice', price: 1500, mealTime: ['Lunch', 'Dinner'] },
      { name: 'Small Chops Platter', price: 2000, mealTime: ['Lunch', 'Dinner'] },
      { name: 'Ice Cream Cup', price: 800, mealTime: ['Lunch', 'Dinner'] },
    ],
  },
  {
    name: 'TechHub',
